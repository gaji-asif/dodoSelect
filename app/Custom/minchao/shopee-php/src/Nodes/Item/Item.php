...
class Item extends NodeAbstract
{
    ...
    /**
     * For getting 2-tier variations (Custom).
     *
     * @param array $parameters
     * @return ResponseData
     */
    ...
    /**
     * Pre-validate your image urls and convert them to Shopee image url to use in item upload APIs.
     *
     * @param array $parameters
     * @return ResponseData
     */
     ...
     * @return ResponseData
     */
    public function addTierVariationList($parameters = []): ResponseData
    {
