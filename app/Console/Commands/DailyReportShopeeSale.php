...
use App\Actions\Shopee\OrderPurchase\DailyReportMessage;
use App\Jobs\SheetTpkSendDailyReport;
use App\Models\SheetDataTpkLineChat;
use Illuminate\Console\Command;

class DailyReportShopeeSale extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dodo:daily-report-shopee-sale
     ...
     * @var string
     */
    protected $description = 'Send Line Apps notification of Shopee sales';
