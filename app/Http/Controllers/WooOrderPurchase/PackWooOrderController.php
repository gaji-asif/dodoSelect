...
namespace App\Http\Controllers\WooOrderPurchase;

use App\Http\Controllers\Controller;
use App\Http\Requests\WooOrderPurchase\Shipment\PackOrderRequest;
use App\Models\Shipment;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\Auth;

class PackWooOrderController extends Controller
{
    /**
