...
class StoreLazadaProductRequest extends FormRequest
{
    ...
    private function getCustomRules() 
    {
        ...
        if (isset($request["lazada_brand"])) {
            $rules["lazada_brand"] = "required|min:2";
        }
        
        if (isset($request["lazada_model"])) {
            $rules["lazada_model"] = "required|min:2";
        }

        if (isset($request["lazada_color_family"])) {
            if (empty($request["lazada_color_family"])) {
                $rules["lazada_color_family"] = "required|min:2";
            }
        }

        if (isset($request["lazada_warranty"])) {
            $rules["lazada_warranty"] = "required|min:2";
        }

        if (isset($request["lazada_warranty_type"])) {
            $rules["lazada_warranty_type"] = "required|min:2";
        }
    ...
    public function messages()
    {
        return array_merge($this->getCustomErrorMessage(), [
            ...
            'lazada_brand.required'             => 'Brand is required',
            'lazada_brand.min'                  => 'Brand is required',
            'lazada_model.required'             => 'Model is required',
            'lazada_model.min'                  => 'Model is required',
            'lazada_warranty.required'          => 'Warranty is required',
            'lazada_warranty.min'               => 'Warranty is required',
            'lazada_warranty_type.required'     => 'Warranty type is required',
            'lazada_warranty_type.min'          => 'Warranty type is required',
            'lazada_color_family.required'      => 'Color family is required',
            'lazada_color_family.min'           => 'Color family is required',
        ]);
    }
