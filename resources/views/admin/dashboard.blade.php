<x-app-layout>
    ...
    <div class="w-full overflow-hidden col-span-12">
        <div class="flex flex-col justify-between gap-8 md:flex-row">
            <div class="md:w-3/5">
                <x-card title="Daily Summary" md="8">
                    <div class="overflow-x-auto">
                        <canvas class="h-56 md:h-72" id="chart" style=""></canvas>
                    </div>
                </x-card>
            </div>
            <div class="md:w-2/5">
                <div class="flex flex-col flex-wrap gap-4 sm:flex-row">
                    <div class="flex flex-row w-full bg-white shadow-sm rounded-lg p-4">
                        <div class="flex items-center justify-center flex-shrink-0 h-16 w-16 rounded-xl bg-blue-100 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-archive"
                                viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="flex flex-row w-full bg-white shadow-sm rounded-lg p-4">
                        ...
                        <div class="flex flex-col justify-center flex-grow ml-4">
                            <div class="text-md text-gray-500">
                                {{ __('translation.Total Sellers') }}
                            </div>
                            <div class="font-bold text-xl">
                                {{ number_format($sellerCount) }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row w-full bg-white shadow-sm rounded-lg p-4">
                        ...
                        <div class="flex flex-col justify-center flex-grow ml-4">
                            <div class="text-md text-gray-500">
                                {{ __('translation.Total Order in Last 7 Days') }}
                            </div>
                            <div class="font-bold text-xl">
