    ...
    <x-card class="mt-0">
        ...
        <card class="bg-gray-500 ">
            <div class="card-title my-4">
                <h4><strong>List Of China Cargo @if (isset($data)) ({{count($data)}}) @endif</strong></h4>
            </div>
            <div class="mt-6 ">
                @if(session('success'))
                ...
                <a href="{{ route('create china cargo')}}">
            ...
            <div class="flex justify-between flex-col">
                <div class="overflow-x-auto">
                    <table class="w-full" id="datatable_1">
                        ...
                        <tbody >
                        @if (isset($data_agent_cargo))

                            @foreach ($data_agent_cargo as $key=>$row)
                                <tr>
                                    <td class="pl-1">{{$key+1}}</td>
                                    <td>{{$row->name}}</td>
                                    <td>
                                    <a href="{{url('china-cargo-edit/'.$row->id)}}">
                                     <button type="button"  class="btn btn-sm bg-green-500 text-white rounded px-2 py-1  capitalize cursor-pointer"><i class="fas fa-pencil-alt"></i></button>
                                     </a>
                                        ...
                                        <div class="modal fade" id="editModal{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{url('domestic_shipper')}}" id="form-update" enctype="multipart/form-data">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title font-bold text-lg" id="exampleModalLabel">Edit</h5>
                                        ...
                                        <div class="modal fade" id="deleteModal{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn bg-gray-500 text-white" data-dismiss="modal">Close</button>
                                                        <a href="{{url('china-cargo-delete/'.$row->id)}}">
