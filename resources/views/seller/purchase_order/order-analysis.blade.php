...
select.select2-hidden-accessible {
    ...
    @if(\App\Models\Role::checkRolePermissions('Can access menu: Purchase Order - Order Analysis'))
                    ...
                    <table class="w-full" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{{ __('translation.PO Qty') }}</th>
                                ...
                                <th class="text-center">{{ __('translation.Supplier') }}</th>
    ...
    @push('bottom_js')
        ...
        <script>
            ...
            const loadOrderAnalysisDataTable = (supplierId,status, categoryId,dateFrom,dateTo) => {
                ...
                $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            name: 'product_cost_suppliers',
                            data: 'product_cost_suppliers'
                        },
                        {
                            name: 'report_status',
                            data: 'report_status'
            ...
            loadOrderAnalysisDataTable(supplierId,status, categoryId);
            ...
            $('#__btnSubmitFilter').click(function() {
                ...
                loadOrderAnalysisDataTable(supplierId,status, categoryId,dateFrom,dateTo);
            });
