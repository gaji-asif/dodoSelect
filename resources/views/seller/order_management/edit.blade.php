                        ...
                        <div class="modal-body">
                            ...
                            @if(isset($paymentDetailsOthers->payment_slip))
                                <div class="form-group">
                                   ...
                                   <img class="img_class mt-2" src="{{ $paymentDetailsOthers->payment_slip_url }}" class="img-responsive">
                                </div>
                            @endif
                            <div class="mt-4 text-center">
                                ...
                                <div id="__productListWrapper">
                                    @foreach ($orderManagement->order_management_details as $detail)
                                        <div class="flex flex-row mb-5 py-4 border border-solid border-t-0 border-r-0 border-l-0 border-gray-200" id="__row_ProductItem_{{ $detail->product->product_code }}">
                                            ...
                                            <input type="hidden" name="product_orginal_discount[]" value="0" min="0" max="{price}" step="0.001" class="product-orginal-discount__field" data-product-code="{{ $detail->product->product_code }}">
                                            @else
                                            <input type="hidden" name="product_orginal_discount[]" value="{{ $detail->price - $detail->discount_price }}" min="0" max="{price}" step="0.001" class="product-orginal-discount__field" data-product-code="{{ $detail->product->product_code }}">
                                            @endif
                                        ...
                                        <div class="mb-4 pb-3 border border-t-0 border-r-0 border-l-0 border-dashed border-gray-300" id="__shippingMethodItem_{{ $shippingItemId }}">
                                            <div class="flex flex-row items-start">
                                                <div>
                                                    ...
                                                    <input type="hidden" name="shipping_method_discount_price[]" value="{{ $shippingCost->price- $shippingCost->discount_price}}" class="shiping-method__discount-price-field">
                                            ...
                                            <div class="mb-4 pb-3 border border-t-0 border-r-0 border-l-0 border-dashed border-gray-300" id="__shippingMethodItem_{{ $shippingItemId }}">
                                                <div class="flex flex-row items-start">
                                                    <div>
                                                        ...
                                                        <input type="hidden" name="shipping_method_discount[]" value="{{ $customerShipping->price- $customerShipping->discount_price}}" class="shiping-method__discount-field">
                                                        <input type="hidden" name="shipping_method_discount_price[]" value="{{ $customerShipping->discount_price }}" class="shiping-method__discount-price-field">
                            ...
                            <div class="w-full lg:w-1/2 lg:mx-auto">
                                <table class="w-full -mt-1">
                                    ...
                                    <tr id="__taxRateRowCartTotals" @if ($orderManagement->tax_enable != $taxEnableYes && $orderManagement->tax_rate <= 0) style="display: none;" @endif>
                                        <td class="pr-3 py-1">
                                            {{ $taxRateSetting->tax_name ?? '' }} (<span id="__taxRateCartTotal">{{ currency_number($taxRateSetting->tax_rate, 2) . '%' }}</span>)
                                        </td>
                                        <td class="py-1">
                                            <span class="text-white">-</span>
                                            <span class="font-bold">
                                        ...
                                        <td class="pl-3 py-1 text-right">
                                            <span class="font-bold" id="__taxRateCurrency">
                                                {{ currency_number($orderManagement->tax_rate, 2) }}
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pl-3 py-1 text-right">
                                                ...
                                                @php
                                                    $in_total = ($orderManagement->sub_total + $orderManagement->shipping_cost + $orderManagement->tax_rate) - $total_product_discount;
                                                @endphp
        ...
        <script>
            ...
            const calculateCartTotal = _ => {
                ...
                $('#__shippingMethodOuterWrapper').find('.shipping-method__id-radio-field').each(function() {
                    ...
                    // discount amount after put a new price
                    let $discountField = $shippingItemWrapper.find('.shiping-method__discount-field');

                     // alert($discountPriceField.val()+'///'+$discountField.val());
                    ...
                    $.ajax({
                        ...
                        beforeSend: function() {
                            ...
                            //$('#__noShippingMethodsWrapper').show();
                             ...
                             // New Changes
                             $('#__shippingMethodListWrapper').show();
                             $('#__shippingMethodEnabledListWrapper').html(null);
                             $('#__shippingMethodEnabledListWrapper').hide();
                        },
            ...
            */
            $('body').on('click', '.shipping-method__btn-product-discount', function() {
                ...
                // $('#__discountPriceAddShippingDiscount').val(discountCostFieldModal);
                  $('#__discountPriceAddShippingDiscount').val(discountShippingCost);
            ...
            function change_payment_status() {
                ...
                //alert(current_status+payment_id+order_id);
                $.ajax({
                    type: 'GET',
                    data: {
                        payment_id: payment_id,
