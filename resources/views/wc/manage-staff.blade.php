                ...
                <div class="modal-update modal-hide">
                    <div style="background-color: rgba(0,0,0,0.5)"
                        ...
                        <div class="bg-white w-11/12 md:max-w-md overflow-y-auto mx-auto rounded shadow-lg pt-4 pb-6 text-left px-6"
                            ...
                            <div class="flex justify-between items-center pb-3">
                                <p class="text-2xl font-bold">Update Staff</p>
                                {{-- tombol close --}}
                            ...
                            <form style="max-height:90vh" method="POST" action="{{ route('staff.update') }}"
                                id="form-update"></form>
                        </div>
                    </div>
                </div>
