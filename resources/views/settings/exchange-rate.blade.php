<x-app-layout>
    ...
    <x-card class="mt-0">
        ...
        <card class="bg-gray-500 ">
            <div class="card-title my-4">
                <h4><strong>List Of Exchange Rate @if (isset($data)) ({{count($data)}}) @endif</strong></h4>
            </div>
            <div class="mt-6 ">
                @if(session('success'))
                ...
                <div class="w-full lg:w-1/4 mb-6 lg:mb-3">
                    <x-button color="green" id="BtnInsert" data-toggle="modal" data-target="#createModal">
                        ...
                        <span class="ml-2">
                            {{ __('translation.Create Exchange Rate') }}
                        </span>
                    </x-button>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full" id="datatable_1">
                        ...
                        <tr class="rounded-lg text-sm font-medium text-gray-700 text-left">
                            ...
                            <th class="px-4 py-2 border-2">Rate</th>
                                        ...
                                        <div class="modal fade" id="editModal{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{url('exchange-rates-update/'.$row->id)}}" id="form-update" enctype="multipart/form-data">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit Exchange Rate</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name='rate' class="form-control" required value="@if(isset($row)){{$row->rate}}@else{{old('rate')}}@endif">
                                                                </div>
                                        ...
                                        <div class="modal fade" id="deleteModal{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div>
                                                            <h6>Do you want to delete this Exchange Rate?</h6>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn bg-gray-500 text-white" data-dismiss="modal">Close</button>
                                                        <a href="{{url('exchange-rates-delete/'.$row->id)}}">
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="POST" action="{{route('exchange-rates.store')}}" id="form-create" enctype="multipart/form-data">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="form-group">
                                <label for="image" class="font-weight-bold">Rate</label>
